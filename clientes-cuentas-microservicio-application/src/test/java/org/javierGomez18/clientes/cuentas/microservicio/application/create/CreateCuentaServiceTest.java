...
class CreateCuentaServiceTest {
  ...
  @Mock private CuentaBancariaCommandRepository cuentaBancariaRepository;

  @InjectMocks private CreateCuentaService service;
  ...
  void shouldCallRepositoryWithConstructedClienteAndCuenta() {
    ...
    verify(cuentaBancariaRepository, times(1))
        .addCuenta(clienteCaptor.capture(), cuentaCaptor.capture());
