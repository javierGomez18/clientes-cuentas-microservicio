...
/**
 * Adaptador: Implementa ClientesQueryRepository (Puerto OUT)
 * Convierte llamadas del dominio a queries JPA
 */
@Slf4j
@Repository
...
public class ClienteRepositoryAdapter implements ClientesQueryRepository {
    ...
    public Optional<Cliente> findByDni(String dni) {
        ...
        log.info("Búsqueda de cliente DNI: {} - {}", dni, cliente.isPresent() ? "ENCONTRADO" : "NO ENCONTRADO");
