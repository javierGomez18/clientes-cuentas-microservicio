...
/**
 * Adaptador: Implementa CuentaBancariaCommandRepository (Puerto OUT)
 * Convierte llamadas del dominio a comandos JPA (escritura)
 * Maneja la lógica de persistencia de cuentas y clientes
 */
@Slf4j
@Repository
