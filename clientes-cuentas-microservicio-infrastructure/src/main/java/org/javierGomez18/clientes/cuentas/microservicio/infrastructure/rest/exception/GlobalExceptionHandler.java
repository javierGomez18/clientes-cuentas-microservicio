...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetailRS> handleCuentaConflictException(CuentaConflictException ex, HttpServletRequest request) {
        ...
        errorResponse.setTimestamp(LocalDateTime.now().atOffset(java.time.ZoneOffset.UTC));
        errorResponse.setInstance(URI.create(request.getRequestURI()));
        errorResponse.setType(ex.getTipo().equals(CuentaConflictException.Tipo.NO_CERRABLE) ?
                URI.create("/errors/cuenta-no-cerrable") : URI.create("/errors/saldo-insuficiente"));
        errorResponse.setDetail(ex.getMessage());
    ...
    public ResponseEntity<ProblemDetailRS> handleCuentaUnprocessableEntityException(CuentaUnprocessableEntityException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ProblemDetailRS> handleMovimientoUnprocessableEntityException(MovimientoUnprocessableEntityException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ProblemDetailRS> handleCuentaNotFoundException(CuentaNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ProblemDetailRS> handleGenericException(Exception ex, HttpServletRequest request) {
