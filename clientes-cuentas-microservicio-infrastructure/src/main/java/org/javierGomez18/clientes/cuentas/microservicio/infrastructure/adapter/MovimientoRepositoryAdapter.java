...
public class MovimientoRepositoryAdapter
    implements MovimientoQueryRepository, MovimientoCommandRepository {
  ...
  public PageResult<Movimiento> findByCuentaId(Long cuentaId, PageRequest pageRequest) {
    ...
    Page<MovimientoEntity> pageResult =
        movimientoJpaRepository.findByCuentaId(
            cuentaId,
  ...
  public Optional<Movimiento> addMovimiento(Movimiento movimiento) {
    ...
    return Optional.of(
        movimientoEntityMapper.toDomain(
            movimientoJpaRepository.save(movimientoEntityMapper.toEntity(movimiento))));
  }
}
