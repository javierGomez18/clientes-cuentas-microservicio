...
class CuentasBancariasControllerUnitTest {
    ...
    @Mock
    UpdateCuentaUseCase updateCuentaUseCase;
    ...
    @InjectMocks
    CuentasBancariasController controller;
    ...
    void createCuenta_callsUseCase_and_returnsCreated() {
        ...
        when(rq.getTipoCuenta()).thenReturn(org.javierGomez18.clientes.cuentas.microservicio.web.dto.CuentaRQ.TipoCuentaEnum.PREMIUM);
    ...
    void realizarMovimiento_returnsMappedMovimiento() {
        ...
        when(rq.getTipoMovimiento()).thenReturn(org.javierGomez18.clientes.cuentas.microservicio.web.dto.MovimientoRQ.TipoMovimientoEnum.RETIRADA);
